...
namespace UnityEngine.XR.Interaction.Toolkit.AR
{
    ...
    /// </summary>
    public static partial class GestureTransformationHelper
    {
        /// <summary>
        ...
        static bool TryGetTrackableManager<T>([CanBeNull] XROrigin sessionOrigin, ref T cachedManager, out T manager)
        {
            ...
            if (sessionOrigin == null)
            {
                if (s_XROrigin == null)
                {
                    ...
                    if (!ComponentLocatorHelper<XROrigin>.TryFindComponent(out s_XROrigin))
                    {
...
#pragma warning disable CS0618 // ARSessionOrigin is deprecated in 5.0, but kept to support older AR Foundation versions
        ...
        static bool TryGetTrackableManager<T>([CanBeNull] ARSessionOrigin sessionOrigin, ref T cachedManager, out T manager)
        {
            ...
            if (sessionOrigin == null)
            {
                ...
                {
                    cachedManager = default;
                    if (!ComponentLocatorHelper<ARSessionOrigin>.TryFindComponent(out s_ARSessionOrigin))
                    {
...
#pragma warning restore CS0618
            ...
            int fallbackLayerMask = 0)
        {
            ...
            screenPosition.y += GestureTouchesHelper.InchesToPixels(screenTouchOffset);
    ...
    public static class ComponentLocatorHelper<T> where T : Component
    {
        ...
        {
            if ((Object)s_ComponentCache == (Object)null)
            {
    ...
    public static class GestureTouchesHelper
    {
